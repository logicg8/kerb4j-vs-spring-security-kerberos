...
public class DummyUserDetailsService implements AuthenticationUserDetailsService<SpnegoAuthenticationToken> {
...
//replace above code with this and re-organize imports for testing spring-security-kerberos
